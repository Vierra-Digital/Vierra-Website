...
export const inputClass =
  "w-full rounded-lg bg-gray-100 px-4 py-2.5 text-[15px] text-[#1A1033] placeholder-gray-400 outline-none transition-all duration-200 hover:bg-gray-200/70 focus:bg-white focus:ring-2 focus:ring-[#701CC0]/40";
