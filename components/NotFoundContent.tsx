...
/**
 * The 404 page body, rendered by both routers.
 *
 * Next needs a not-found page per router — `app/not-found.tsx` for the App Router and
 * `pages/404.tsx` for the Pages Router — and neither can serve the other's routes. The two files
 * were byte-identical apart from the name of the exported function, so any change to one silently
 * left the other behind. They are thin wrappers around this now.
 */
