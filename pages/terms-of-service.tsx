  ...
  return (
    <>
      ...
      <div className={`relative min-h-screen bg-[#F3F3F3] text-[#2A2140] ${inter.className}`}>
        ...
        {/* Dark hero band — half-height dark hero in the Blog format */}
          ...
          <div className="lg:grid lg:grid-cols-[260px_1fr] lg:gap-12">
            ...
            <main>
              ...
              <div className="space-y-6">
                  <Section id="agreement" index={1} title="Agreement to Our Legal Terms">
                    <p>
                    ...
                    <p>
                      You can contact us by phone at (+1) 339-333-0929, or email at <a href="mailto:business@vierradev.com">business@vierradev.com</a>.
                    </p>
                    <p>
                    ...
                    <p>
                      We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal Terms will become effective upon posting or notifying you by <a href="mailto:business@vierradev.com">business@vierradev.com</a>, as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.
                    </p>
                    <p>
                  ...
                  <Section id="our-services" index={2} title="Our Services">
                    <p>
                  ...
                  <Section id="ip-rights" index={3} title="Intellectual Property Rights">
                    <p>
                    ...
                    <p>The Content and Marks are provided in or through the Services &quot;AS IS&quot; for your personal, noncommercial use or internal business purposes only.</p>
                    ...
                    <p>
                      If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:business@vierradev.com">business@vierradev.com</a>. If we ever grant you permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.
                    </p>
                    <p>
                  ...
                  <Section id="user-representations" index={4} title="User Representations">
                    <p>
                  ...
                  <Section id="subscriptions" index={5} title="Subscriptions">
                    <p>
                    ...
                    <p>
                      You can cancel your subscription at any time by contacting us using the contact information provided below. Your cancellation will take effect at the end of the current paid term. If you have any questions or are unsatisfied with our Services, please email us at <a href="mailto:business@vierradev.com">business@vierradev.com</a>.
                    </p>
                    <p>We may, from time to time, make changes to the subscription fee and will communicate any price changes to you per applicable law.</p>
                  </Section>

                  <Section id="prohibited" index={6} title="Prohibited Activities">
                    <p>
                  ...
                  <Section id="ugc" index={7} title="User-Generated Contributions">
                    <p>
                  ...
                  <Section id="contribution-license" index={8} title="Contribution License">
                    <p>
                  ...
                  <Section id="third-party" index={9} title="Third-Party Websites and Content">
                    <p>
                  ...
                  <Section id="services-management" index={10} title="Services Management">
                    <p>
                  ...
                  <Section id="privacy" index={11} title="Privacy Policy">
                    <p>
                      We care about data privacy and security. Please review our Privacy Policy: <Link href="/privacy-policy" legacyBehavior><a>https://vierradev.com/privacy-policy</a></Link>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Services, you are transferring your data to the United States, and you expressly consent to have your data transferred to and processed in the United States.
                    </p>
                  </Section>

                  <Section id="term-termination" index={12} title="Term and Termination">
                    <p>
                  ...
                  <Section id="modifications" index={13} title="Modifications and Interruptions">
                    <p>
                  ...
                  <Section id="governing-law" index={14} title="Governing Law">
                    <p>
                  ...
                  <Section id="dispute" index={15} title="Dispute Resolution">
                    <p>
                  ...
                  <Section id="corrections" index={16} title="Corrections">
                    <p>
                      There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.
                    </p>
                  </Section>

                  <Section id="disclaimer" index={17} title="Disclaimer">
                    <p>
                  ...
                  <Section id="liability" index={18} title="Limitations of Liability">
                    <p>
                  ...
                  <Section id="indemnification" index={19} title="Indemnification">
                    <p>
                  ...
                  <Section id="user-data" index={20} title="User Data">
                    <p>
                  ...
                  <Section id="electronic" index={21} title="Electronic Communications, Transactions, and Signatures">
                    <p>
                  ...
                  <Section id="sms" index={22} title="SMS Text Messaging">
                    ...
                    <p>
                      If you have any questions or need assistance regarding our SMS communications, please email us at <a href="mailto:business@vierradev.com">business@vierradev.com</a> or call (+1) 339-333-0929.
                    </p>
                  </Section>

                  <Section id="california" index={23} title="California Users and Residents">
                    <p>
                      If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs in writing at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834 or by telephone at (800) 952-5210 or (916) 445-1254.
                    </p>
                  </Section>

                  <Section id="miscellaneous" index={24} title="Miscellaneous">
                    <p>
                  ...
                  <Section id="contact" index={25} title="Contact">
                    <p>To resolve a complaint regarding the Services or to receive further information regarding the use of the Services, please contact us at:</p>
