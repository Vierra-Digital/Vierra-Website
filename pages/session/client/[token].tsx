        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="flex-1 p-4 lg:p-8 flex flex-col items-center">
            <div className="w-full max-w-4xl">
              <h1 className={`text-2xl lg:text-3xl font-bold text-gray-900 mb-6 lg:mb-8 ${bricolage.className}`}>
                {q.label}
              </h1>
              ...
              {q.type === "video" ? (
                ...
                <div className="bg-black rounded-lg overflow-hidden mb-4 lg:mb-6 relative w-full" style={{ aspectRatio: '16/9' }}>
                  <video 
                    src={q.videoUrl} 
                    controls 
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-2 lg:p-4">
                    <div className="flex items-center gap-2 lg:gap-4 text-white">
                      {/* Play Controls */}
                      <button 
                        className="w-6 h-6 lg:w-8 lg:h-8 flex items-center justify-center hover:bg-white/20 rounded"
                        onClick={prevStep}
                        disabled={step === 0}
                      >
                        <svg width="12" height="12" className="lg:w-4 lg:h-4" viewBox="0 0 24 24" fill="currentColor">
                          <path d="M6 6h2v12H6zm3.5 6l8.5 6V6z"/>
                        </svg>
                      </button>
                      
                      <button className="w-6 h-6 lg:w-8 lg:h-8 flex items-center justify-center hover:bg-white/20 rounded">
                        <div className="w-0 h-0 border-l-[6px] lg:border-l-[8px] border-l-white border-y-[4px] lg:border-y-[6px] border-y-transparent"></div>
                      </button>
                      ...
                      {/* Volume and Settings - Hidden on mobile */}
                      <button className="hidden lg:flex w-8 h-8 items-center justify-center hover:bg-white/20 rounded">
                ...
                /* Social Connect Card */
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-4 lg:p-8 mb-4 lg:mb-6 border border-purple-200">
                  <h3 className={`text-xl lg:text-2xl font-bold text-gray-900 mb-4 lg:mb-6 ${bricolage.className}`}>Connect Your Accounts</h3>
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <button
                      type="button"
                      onClick={() => startOauth("facebook")}
                      className="flex flex-col items-center p-4 lg:p-6 bg-white rounded-lg hover:bg-gray-50 transition border border-gray-200 shadow-sm"
                    >
                      <div className="w-10 h-10 lg:w-12 lg:h-12 bg-blue-600 rounded-lg mb-2 lg:mb-3 flex items-center justify-center">
                        <svg width="20" height="20" className="lg:w-6 lg:h-6" viewBox="0 0 24 24" fill="white">
                    ...
                    <button
                      ...
                      className="flex flex-col items-center p-4 lg:p-6 bg-white rounded-lg hover:bg-gray-50 transition border border-gray-200 shadow-sm"
                    >
                      <div className="w-10 h-10 lg:w-12 lg:h-12 bg-blue-700 rounded-lg mb-2 lg:mb-3 flex items-center justify-center">
                        <svg width="20" height="20" className="lg:w-6 lg:h-6" viewBox="0 0 24 24" fill="white">
                          <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                        </svg>
                      </div>
                      <span className="font-medium text-gray-900 text-sm lg:text-base">LinkedIn</span>
                      <span className="text-xs text-green-600 mt-1">
                    ...
                    <button
                      ...
                      className="flex flex-col items-center p-4 lg:p-6 bg-white rounded-lg hover:bg-gray-50 transition border border-gray-200 shadow-sm"
                    >
                      <div className="w-10 h-10 lg:w-12 lg:h-12 bg-red-600 rounded-lg mb-2 lg:mb-3 flex items-center justify-center">
                        <svg width="20" height="20" className="lg:w-6 lg:h-6" viewBox="0 0 24 24" fill="white">
                      ...
                      <span className="font-medium text-gray-900 text-sm lg:text-base">Google Ads</span>
                      <span className="text-xs text-green-600 mt-1">
                  ...
                  <button
                    ...
                    className="mt-4 lg:mt-6 px-4 py-2 bg-[#7A13D0] text-white rounded-lg hover:bg-[#6B11B8] transition text-sm font-medium"
                ...
                /* Text Question Card */
                <div className="bg-gray-50 rounded-lg p-4 lg:p-8 mb-4 lg:mb-6 border border-gray-200">
                  <h3 className={`text-xl lg:text-2xl font-bold text-gray-900 mb-4 lg:mb-6 ${bricolage.className}`}>{q.label}</h3>
                  <input
                    type="text"
                    id={q.name}
                    name={q.name}
                    ...
                    className={`w-full p-3 lg:p-4 bg-white border border-gray-300 rounded-lg text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-[#7A13D0] focus:border-transparent ${inter.className}`}
                    autoComplete="off"
                  />
                </div>
              )}
              ...
              <div className="mb-4 lg:mb-6">
                <h3 className={`text-base lg:text-lg font-semibold text-gray-900 mb-3 ${bricolage.className}`}>
                  Feedback
                </h3>
                <textarea
          ...
          <div className="w-full lg:w-80 bg-white p-4 lg:p-6 border-t lg:border-t-0 lg:border-l border-gray-200">
            <h3 className={`text-base lg:text-lg font-semibold text-gray-900 mb-4 ${bricolage.className}`}>
              Modules
            </h3>
