 ...
 * (pages/api/campaigns/[id]/contacts/[contactId].ts) and the Smartlead webhook's hard-bounce/
 * unsubscribe handling (pages/api/campaigns/webhooks/smartlead.ts).
 */
export async function addToDnc(campaignId: string, contactEmail: string, reason: "categorization" | "bounce" = "categorization") {
